# Generated by Django 3.0.8 on 2021-10-09 00:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(blank=True, choices=[('METERS', 'METERS'), ('PACKET', 'PACKET')], max_length=200)),
                ('item_description', models.TextField(blank=True, default=0, max_length=200)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, unique=True)),
                ('primary_contact_person', models.CharField(blank=True, max_length=200)),
                ...
                ('shipping_address', models.TextField(blank=True, max_length=200)),
                ('billing_address', models.TextField(blank=True, max_length=200)),
                ('other_details', models.TextField(blank=True, max_length=200)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.IntegerField(default=0, null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
