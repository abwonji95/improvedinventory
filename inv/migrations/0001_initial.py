# Generated by Django 3.0.8 on 2021-09-10 10:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='inv.Vendor')),
            ],
        ),
        migrations.AddField(
            model_name='purchase',
            name='item',
            field=models.ManyToManyField(through='inv.Purchasedetails', to='inv.Item'),
        ),
        migrations.AddField(
            model_name='purchase',
            name='vendor',
